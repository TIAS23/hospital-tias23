...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 text-sm">
                        <div class="site-info">
                            <a href="#"><span class="mai-call text-primary"></span> +6282228163135</a>
                            <span class="divider">|</span>
                            <a href="#"><span class="mai-mail text-primary"></span> tiasluthfiana@gmail.com</a>
                        </div>
                    </div>
    ...
    <thead>
        <tr style="background-color: black;">
            <th colspan="5" class="text-center" style="font-size: 20px; color: white;">Appointment Details</th>
        </tr>
        <tr style="background-color: black;">
